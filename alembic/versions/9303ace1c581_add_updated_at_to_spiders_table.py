"""Add updated_at to spiders table

Revision ID: 9303ace1c581
Revises: 0eaf10302cea
Create Date: 2025-12-05 01:58:00.010544
...
revision: str = '9303ace1c581'
down_revision: Union[str, Sequence[str], None] = '0eaf10302cea'
...
def upgrade() -> None:
    ...
    op.drop_index(op.f('ix_extraction_failures_id'), table_name='extraction_failures')
    ...
    op.drop_table('sites')
    op.add_column('spiders', sa.Column('updated_at', sa.DateTime(), nullable=True))
...
def downgrade() -> None:
    """Downgrade schema."""
    # ### commands auto generated by Alembic - please adjust! ###
    op.drop_column('spiders', 'updated_at')
