...
def _pdf_exclude_instructions(project):
    ...
    return (
        ...
        "'site37.org' hides site37.org AND wedocs.site37.org, but not 'notsite37.org'. 'block_tlds' hides "
...
def _pdf_exclude_infobox(project, cfg):
    ...
    return (
        ...
        "the signal. Matching is dot-boundary suffix (<code>site37.org</code> also hides "
        "<code>wedocs.site37.org</code>). Nothing is deleted — the crawl data and "
