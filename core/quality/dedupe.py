...
Usage:
  ./scrapai dedupe --project myproject                 # url+content dedupe
  ./scrapai dedupe --project myproject --latest-only   # keep newest row per URL
  ./scrapai dedupe --project myproject --only site15_gov   # one spider only
