...
# describing the operator's own automated collection (the acme.org false positive), NOR a GDPR
...
# `process\w*` is deliberately excluded from the automated-X targets (the site44.org FP).
_SCRAPE_TGT = (
