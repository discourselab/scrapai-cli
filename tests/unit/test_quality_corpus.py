...
def test_url_host_and_domains():
    assert corpus.url_host("https://www.wedocs.site37.org/x.pdf") == "wedocs.site37.org"
    assert corpus.url_host("bad url") == ""
    assert corpus.host_in_domains("wedocs.site37.org", ["site37.org"])
    assert corpus.host_in_domains("www.site37.org", ["site37.org"])
    assert not corpus.host_in_domains("notsite37.org", ["site37.org"])  # dot boundary
    assert not corpus.host_in_domains("", ["site37.org"])
    assert not corpus.host_in_domains("site37.org", [])
